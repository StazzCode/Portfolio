        ...
        <div className="flex flex-col justify-start space-y-32 h-screen border border-blue-500">
            ...
            <div className="border border-red-500 h-1/2 relative flex flex-col justify-center">
                ...
                <div className="carousel carousel-center space-x-96 h-full overflow-y-hidden absolute max-w-full px-96">
                    ...
                    <div className="carousel-item w-full cursor-pointer relative rounded-xl overflow-hidden shadow-md" onClick={goToPortfolio}>
                    ...
                    <div className="carousel-item w-full cursor-pointer relative rounded-xl overflow-hidden shadow-md" onClick={goToBDD}>
