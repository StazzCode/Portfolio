            ...
            <div className=" flex flex-col lg:flex-row justify-around h-2/5 border border-red-500">
                <div className="flex flex-col justify-start flex-grow mx-12 w-1/3 h-full card rounded-box bg-slate-100 overflow-hidden text-xl font-bold shadow-md">
                    ...
                    <ul className="flex flex-col justify-around h-full m-3 list-none">
                        ...
                        <li className="flex flex-row items-center space-x-2"><GlobeIcon/><a href="https://lycee-gustave-eiffel.fr">Lycée Polyvalent Gustave Eiffel, Armentières</a></li>
                    </ul>
                </div>  
                <div className="flex flex-col justify-start flex-grow mx-12 w-1/3 h-full card rounded-box bg-slate-100 overflow-hidden text-xl font-bold shadow-md">
                    <div className="bg-lightheader font-extrabold text-4xl flex flex-col justify-center h-16 shadow">
                    ...
                    <ul className="flex flex-col justify-around h-full m-3 list-none">
                        ...
                        <li className="flex flex-row items-center space-x-2"><GlobeIcon/><a href="http://iut.univ-lille.frdut-info">IUT de Lille, Villeneuve d’Asques</a></li>
                    </ul>
